# Support for Output Descriptors in TrueFreedomCoin Core

Since TrueFreedomCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `tfc1...` for mainnet or `ttfc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on TrueFreedomCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TrueFreedomCoin Core wallets, a convenience function `combo` is
