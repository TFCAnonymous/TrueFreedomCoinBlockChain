...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " truefreedomcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  truefreedomcoin-tx [options] <hex-tx> [commands]  Update hex-encoded truefreedomcoin transaction\n" +
            "or:     truefreedomcoin-tx [options] -create [commands]   Create hex-encoded truefreedomcoin transaction\n" +
            "\n";
