...
"""Verify that starting truefreedomcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start truefreedomcoin with -h for help text")
        ...
        self.log.info("Start truefreedomcoin with -version for version information")
        ...
        self.log.info("Start truefreedomcoind with -fakearg to make sure it does not start")
