...
bech32_templates = [
  ...
  ('tfc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('tfc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('tfc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttfc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttfc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttfc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtfc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtfc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtfc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttfc',  17, 32, False, False, False),
  ('rtfc',  3,  1, False, False, False),
  ('tfc',   15, 41, False, False, False),
  ('ttfc',  0, 16, False, False, False),
  ('rtfc',  0, 32, True,  False, False),
  ('tfc',   0, 16, True,  False, False),
  ('ttfc',  0, 32, False, True,  False),
  ('rtfc',  0, 20, False, False, True)
]
